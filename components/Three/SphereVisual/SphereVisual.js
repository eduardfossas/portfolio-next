...
float cnoise(in vec4 P) {
    ...
    return 2.2 * n_xyzw;
        ...
        vec3 getDisplacedPosition(vec3 _position)
        {
            ...
            distoredPosition += cnoise(vec4(distoredPosition * uDistortionFrequency, uTime)) * uDistortionStrength;
        
            float perlinStrength = cnoise(vec4(distoredPosition * uDistortionFrequency, uTime));
            
            vec3 displacedPosition = _position;
            displacedPosition += _position * perlinStrength * uDisplacementStrength;
